...
return [
    ...
    */
    ...
    'channels' => [
        ...
        'encuestas' => [
            'driver' => 'daily',
            'path' => storage_path('logs/encuestas.log'),
            'level' => env('LOG_LEVEL', 'info'),
            'days' => env('LOG_DAILY_DAYS', 30),
            'replace_placeholders' => true,
        ],
        ...
        'isu_report' => [
            'driver' => 'daily',
            'path' => storage_path('logs/isu_report.log'),
            'level' => env('LOG_LEVEL', 'info'),
            'days' => env('LOG_DAILY_DAYS', 30),
            'replace_placeholders' => true,
        ],
        ...
        'reservas_horarios' => [
            'driver' => 'daily',
            'path' => storage_path('logs/reservas_horarios.log'),
            'level' => env('LOG_LEVEL', 'info'),
            'days' => env('LOG_DAILY_DAYS', 30),
            'replace_placeholders' => true,
        ],
        ...
        'cancelaciones' => [
            'driver' => 'daily',
            'path' => storage_path('logs/cancelaciones.log'),
            'level' => env('LOG_LEVEL', 'info'),
            'days' => env('LOG_DAILY_DAYS', 30),
            'replace_placeholders' => true,
        ],
